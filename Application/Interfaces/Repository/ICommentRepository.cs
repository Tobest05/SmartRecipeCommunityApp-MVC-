...
namespace Application.Interfaces.Repository
{
    public interface ICommentRepository
    {
        ...
        Task<ICollection<RecipeComment>> GetRecipeCommentByRecipeIdAsync(Guid recipeId);

        Task<ICollection<RecipeComment>> GetRecipeCommentByCustomerIdAsync(Guid customerId);
