...
namespace Application.Services.Implementation
{
    public class InstructionService : IInstructionService
    {
        ...
        public async Task<BaseResponse<CreateInstructionResponseModel>> AddInstructionAsync(CreateInstructionRequestModel request)
        {
            ...
            if (recipe == null)
            {
                return BaseResponse<CreateInstructionResponseModel>.Failure("Recipe not found.");
            }
            ...
            return BaseResponse<CreateInstructionResponseModel>.Success("Instruction added successfully.", response);
        }
        ...
        public async Task<BaseResponse<CreateInstructionResponseModel>> GetInstructionByIdAsync(Guid id)
        {
            ...
            if (instruction == null)
            {
                return BaseResponse<CreateInstructionResponseModel>.Failure("Instruction not found.");
            }

            var response = instruction.Adapt<CreateInstructionResponseModel>();

            return BaseResponse<CreateInstructionResponseModel>.Success("Instruction retrieved successfully.", response);
        }
        ...
        public async Task<BaseResponse<ICollection<CreateInstructionResponseModel>>> GetAllInstructionAsync()
        {
            ...
            return BaseResponse<ICollection<CreateInstructionResponseModel>>.Success("Instructions retrieved successfully.", response);
        }
        ...
        public async Task<BaseResponse<UpdateInstructionResponseModel>> UpdateInstructionAsync(UpdateInstructionRequestModel request)
        {
            ...
            if (instruction == null)
            {
                return BaseResponse<UpdateInstructionResponseModel>.Failure("Instruction not found.");
            }
            ...
            return BaseResponse<UpdateInstructionResponseModel>.Success("Instruction updated successfully.", response);
        }
        ...
        public async Task<BaseResponse<bool>> DeleteInstructionAsync(Guid id)
        {
            ...
            return BaseResponse<bool>.Success("Instruction deleted successfully.", true);
        }
    }
}
