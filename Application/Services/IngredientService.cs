...
namespace Application.Services.Implementation
{
    public class IngredientService : IIngredientService
    {
        ...
        public async Task<BaseResponse<CreateIngredientResponseModel>> AddIngredientAsync(CreateIngredientRequestModel request)
        {
            ...
            if (recipe == null)
            {
                return BaseResponse<CreateIngredientResponseModel>.Failure("Recipe not found.");
            }
            ...
            if (exist == true)
            {
                return BaseResponse<CreateIngredientResponseModel>.Failure("Ingredient already exists.");
            }
            ...
            return BaseResponse<CreateIngredientResponseModel>.Success("Ingredient added successfully.", response);
        }
        ...
        public async Task<BaseResponse<CreateIngredientResponseModel>> GetIngredientByIdAsync(Guid id)
        {
            ...
            if (ingredient == null)
            {
                return BaseResponse<CreateIngredientResponseModel>.Failure("Ingredient not found.");
            }

            var response = ingredient.Adapt<CreateIngredientResponseModel>();

            return BaseResponse<CreateIngredientResponseModel>.Success("Ingredient retrieved successfully.", response);
        }
        ...
        public async Task<BaseResponse<ICollection<CreateIngredientResponseModel>>> GetAllIngredientAsync()
        {
            ...
            return BaseResponse<ICollection<CreateIngredientResponseModel>>.Success("Ingredients retrieved successfully.", response);
        }
        ...
        public async Task<BaseResponse<UpdateIngredientResponseModel>> UpdateIngredientAsync(UpdateIngredientRequestModel request)
        {
            ...
            if (ingredient == null)
            {
                return BaseResponse<UpdateIngredientResponseModel>.Failure("Ingredient not found.");
            }
            ...
            return BaseResponse<UpdateIngredientResponseModel>.Success("Ingredient updated successfully.", response);
        }
        ...
        public async Task<BaseResponse<bool>> DeleteIngredientAsync(Guid id)
        {
            ...
            if (ingredient == null)
            {
                return BaseResponse<bool>.Failure("Ingredient not found.");
            }
            ...
            return BaseResponse<bool>.Success("Ingredient deleted successfully.", true);
        }
    }
}
