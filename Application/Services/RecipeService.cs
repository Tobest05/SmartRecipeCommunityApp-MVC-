...
namespace Application.Services.Implementation
{
    public class RecipeService : IRecipeService
    {
        ...
        public async Task<BaseResponse<CreateRecipeResponseModel>> AddRecipeAsync( CreateRecipeRequestModel request,Guid userId)
        {
            ...
            var imagePath = await _imageService.UploadImageAsync(request.ImageUrl,"recipes");
            ...
            recipe.CreatedBy = $"{customer.FirstName} {customer.LastName}";
        ...
        public async Task<BaseResponse<ICollection<CreateRecipeResponseModel>>> GetAllRecipeAsync()
        {
            ...
            return BaseResponse<ICollection<CreateRecipeResponseModel>>.Success("Recipes retrieved successfully.", response);
        }
        ...
        public async Task<BaseResponse<ICollection<CreateRecipeResponseModel>>> GetRecipeByCustomerAsync(Guid customerId)
        {
            ...
            if (customer == null)
            {
                return BaseResponse<ICollection<CreateRecipeResponseModel>>.Failure("Customer not found.");
            }
        ...
        public async Task<BaseResponse<ICollection<CreateRecipeResponseModel>>> GetRecipeByCategoryAsync(Guid categoryId)
        {
            ...
            if (category == null)
            {
                return BaseResponse<ICollection<CreateRecipeResponseModel>>.Failure("Category not found.");
            }
        ...
        public async Task<BaseResponse<UpdateRecipeResponseModel>> UpdateRecipeAsync(UpdateRecipeRequestModel request)
        {
            ...
            if (recipe == null)
            {
                return BaseResponse<UpdateRecipeResponseModel>.Failure("Recipe not found.");
            }
            ...
            {
                recipe.ImageUrl = await _imageService.UploadImageAsync(request.ImageUrl,"recipes");
            }
            ...
            return BaseResponse<UpdateRecipeResponseModel>.Success("Recipe updated successfully.", response);
        }
        ...
        public async Task<BaseResponse<bool>> DeleteRecipeAsync(Guid id)
        {
            ...
            if (recipe == null)
            {
                return BaseResponse<bool>.Failure("Recipe not found.");
            }
            ...
            return BaseResponse<bool>.Success("Recipe deleted successfully.", true);
        }
        ...
        public async Task<BaseResponse<RecipeDetailsViewModel>> GetRecipeDetailsAsync(Guid id,Guid? customerId)
        {
            ...
            if (recipe == null)
            {
                return BaseResponse<RecipeDetailsViewModel>.Failure("Recipe not found.");
            }

            var averageRating = recipe.RecipeRating.Any()
                ? recipe.RecipeRating.Average(x => x.Rating) : 0;
            ...
            if (customerId.HasValue)
            {
                ...
                if (customer != null)
                {
                    var existingLike = await _recipeLikeRepository.GetAsync(customer.Id, recipe.Id);
            ...
            var model = new RecipeDetailsViewModel
            {
                ...
                CustomerName = recipe.Customer == null ? "Unknown" : $"{recipe.Customer.FirstName} {recipe.Customer.LastName}",
                ...
                Instructions = recipe.Instruction.OrderBy(x => x.StepNumber).Adapt<ICollection<CreateInstructionResponseModel>>(),

                Ingredients = recipe.Ingredients.Adapt<ICollection<CreateIngredientResponseModel>>(),

                Comments = recipe.RecipeComment.Adapt<ICollection<CreateRecipeCommentResponseModel>>()
            };

            return BaseResponse<RecipeDetailsViewModel>.Success("Recipe details retrieved successfully.",model);
        }
        ...
        public async Task<BaseResponse<ICollection<MyRecipeResponseModel>>> GetMyRecipesAsync(Guid customerId)
        {
           var customer = await _customerRepository.GetByIdAsync(customerId);
            ...
            return BaseResponse<ICollection<MyRecipeResponseModel>>.Success("My recipes retrieved successfully.", response);
        }
    }
}
