        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipeLikes_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2026, 8, 11, 12, 46, 20, 170, DateTimeKind.Utc).AddTicks(9631), "Admin" },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2026, 8, 11, 12, 46, 20, 171, DateTimeKind.Utc).AddTicks(190), "Customer" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreatedAt", "Email", "Password" },
                values: new object[] { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 8, 11, 12, 46, 20, 508, DateTimeKind.Utc).AddTicks(4038), "admin@smartrecipe.com", "$2a$11$jJSG0ot36TefByB.yk2Nn.i46MvuIl85TksbFeDxywMG10ghJD2k." });

            migrationBuilder.InsertData(
                table: "UserRole",
                columns: new[] { "Id", "CreatedAt", "RoleId", "UserId" },
                values: new object[] { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2026, 8, 11, 12, 46, 20, 508, DateTimeKind.Utc).AddTicks(7463), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("22222222-2222-2222-2222-222222222222") });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeLikes_CustomerId",
                table: "RecipeLikes",
                column: "CustomerId");
