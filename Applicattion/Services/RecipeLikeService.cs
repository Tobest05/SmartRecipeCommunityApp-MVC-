...
namespace Application.Services
{
    public class RecipeLikeService : IRecipeLikeService
    {
        ...
        public async Task<BaseResponse<RecipeLikeResponse>> LikeAsync( Guid userId, RecipeLikeRequest request)
        {
            ...
            if (customer == null)
            {
                return BaseResponse<RecipeLikeResponse>
            ...
            var existingLike = await _recipeLikeRepository
                .GetAsync(customer.Id,request.RecipeId);

            if (existingLike != null)
            {
                return BaseResponse<RecipeLikeResponse>
                    .Failure("You already liked this recipe.");
            }
            ...
            var likeCount = await _recipeLikeRepository
                .GetLikeCountAsync(request.RecipeId);
            ...
            RecipeLikeRequest request)
        {
            ...
            {
                return BaseResponse<RecipeLikeResponse>
                    .Failure("You have not liked this recipe.");
            }
        ...
        public async Task<BaseResponse<RecipeLikeResponse>> GetLikeAsync(
            Guid userId,
            Guid recipeId)
        {
            var customer = await _customerRepository.GetByUserIdAsync(userId);
